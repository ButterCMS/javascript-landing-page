...
async function fetchPage() {
    ...
    const menuItems = await butter.content.retrieve([
        "menu"
    ]).then((res)=>res.data.data);
    const { testimonial  } = await butter.content.retrieve([
        "testimonial"
    ]).then((res)=>res.data.data);
...
},{"buttercms":"40dXS"}],"40dXS":[function(require,module,exports) {
"use strict";
...
function Butter(apiToken, testMode, timeout, axiosHook) {
    if (!(this instanceof Butter)) return new Butter(apiToken, testMode, timeout, axiosHook);
    if (!apiToken) throw "ButterCMS API token not set";
...
Butter.prototype = {
    _prepResources: function(requestMethods) {
        for(var name in resources)this[name[0].toLowerCase() + name.substring(1)] = new resources[name](requestMethods);
    },
    _prepMethods: function(apiToken, testMode, timeout, axiosHook) {
        return {
            get: function(url, params) {
                ...
                if (typeof window === "undefined") headers["Accept-Encoding"] = "gzip";
                var conn = axios.create({
                    baseURL: "https://api.buttercms.com/v2",
                    timeout: timeout,
                    headers: headers
                });
                if (axiosHook) axiosHook(conn);
                var params = params || {};
...
},{"axios":"jo6P5","./resources/Post":"d5Kk9","./resources/Category":"aEirT","./resources/Tag":"jga9f","./resources/Author":"aApE1","./resources/Feed":"kHW4N","./resources/Content":"2lWpa","./resources/Page":"h0nMP"}],"jo6P5":[function(require,module,exports) {
...
},{}],"d5Kk9":[function(require,module,exports) {
"use strict";
function Post(conn) {
    this._conn = conn;
}
...
},{}],"aEirT":[function(require,module,exports) {
"use strict";
...
},{}],"jga9f":[function(require,module,exports) {
"use strict";
function Tag(conn) {
    this._conn = conn;
}
...
},{}],"aApE1":[function(require,module,exports) {
"use strict";
...
},{}],"kHW4N":[function(require,module,exports) {
"use strict";
function Feed(conn) {
    this._conn = conn;
}
...
},{}],"2lWpa":[function(require,module,exports) {
"use strict";
...
},{}],"h0nMP":[function(require,module,exports) {
"use strict";
function Page(conn) {
    this._conn = conn;
}
...
},{}]},["jQVXF","1SICI"], "1SICI", "parcelRequirec329")
